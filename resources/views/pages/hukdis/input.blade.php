...
@section('subhead')
    <title>Daftar - Hukuman Displin</title>
@endsection
...
@endif
<form action="{{route('store-hukdis')}}" method="post" class="intro-y col-span-12 lg:col-span-6">
    {{ csrf_field() }}
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-b dark:border-dark-5">
                            <input name="proses_setjen_{{$data->id}}" type="number" class="form-control sm:mt-0" value="0">
                        </td>
                        <td class="border-b dark:border-dark-5">
                            <input name="proses_satker_{{$data->id}}" type="number" class="form-control sm:mt-0" value="0">
                        </td>
                        <td class="border-b dark:border-dark-5">
                            <input name="sk_terbit_{{$data->id}}" type="number" class="form-control sm:mt-0" value="0">
                        </td>
                    </tr>
                    @endforeach
                </tbody>
