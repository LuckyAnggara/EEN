...
@section('subhead')
    <title>Daftar - Kinerja Lainnya</title>
@endsection

@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Daftar Kinerja Lainnya</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a class="btn btn-primary shadow-md mr-2" href="{{ url('input-form-kinerja-lainnya') }}">Tambah Kegiatan</a>
        </div>
    </div>
    ...
    <div class="intro-y box p-5 mt-5">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="{{ route('list-kinerja-lainnya') }}" method="GET"  id="tabulator-html-filter-form" class="xl:flex sm:mr-auto" >
            ...
            <table class="table">
                <thead>
                    <tr class="bg-gray-700 dark:bg-dark-1 text-white">
                        ...
                        <th class="border-b-2 dark:border-dark-5 whitespace-nowrap">Pelaksana</th>
                        <th class="border-b-2 dark:border-dark-5 whitespace-nowrap">Kegiatan</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-b dark:border-dark-5">{{$data->pelaksana}}</td>
                        <td class="border-b dark:border-dark-5">{{$data->kegiatan}}</td>
                        <td class="border-b dark:border-dark-5">
                            <div class="box mt-5">
                            {{-- <a class="btn btn-sm btn-warning mr-1 mb-2" href="javascript:;">
                                <i data-feather="edit" class="w-3 h-3"></i>
                            </a> --}}
                            <a class="btn btn-sm  btn-danger mr-1 mb-2" href="{{ url('kinerja-lainnya/'.$data->id.'/delete') }}">
