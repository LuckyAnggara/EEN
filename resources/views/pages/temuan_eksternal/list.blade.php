...
@section('subhead')
    <title>Daftar - TL Temuan Eksternal</title>
@endsection

@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Daftar Tindak Lanjut Temuan Eksternal</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a class="btn btn-primary shadow-md mr-2" href="{{ url('input-form-temuan-eksternal') }}">Tambah Temuan</a>
        </div>
    </div>
    ...
    <div class="intro-y box p-5 mt-5">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="{{ route('list-temuan-eksternal') }}" method="GET"  id="tabulator-html-filter-form" class="xl:flex sm:mr-auto" >
            ...
            <table class="table">
                <thead>
                    <tr class="bg-gray-700 dark:bg-dark-1 text-white" style="width=100%">
                        ...
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap" colspan="2">Rekomendasi</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap" colspan="2">Sesuai Rekomendasi</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap" colspan="2">Belum Sesuai / Proses TL</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap" colspan="2">Belum TL</th>
                        <th class="border border-b-2 dark:border-dark-5" style="vertical-align:middle" rowspan="2">Nilai Penyerahan Aset/Penyetoran Uang ke Kas Negara</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-b dark:border-dark-5">{{$data->obrik}} <br>({{$data->tahun == null ? '' : $data->tahun }})</td>
                        <td class="border-b dark:border-dark-5">{{$data->rekomendasi_jumlah == null ? '-' :$data->rekomendasi_jumlah }}</td>
                        <td class="border-b dark:border-dark-5">{{$data->rekomendasi_nominal == null ? '-' :number_format($data->rekomendasi_nominal, 0) }}</td>
                        <td class="border-b dark:border-dark-5">{{$data->sesuai_jumlah  == null ? '-' :$data->sesuai_jumlah }}</td>
                        <td class="border-b dark:border-dark-5">{{$data->sesuai_nominal == null ? '-' : number_format($data->sesuai_nominal, 0)}}</td>
                        <td class="border-b dark:border-dark-5">{{$data->proses_tl_jumlah  == null ? '-' :$data->proses_tl_jumlah }}</td>
                        <td class="border-b dark:border-dark-5">{{$data->proses_tl_nominal == null ? '-' : number_format($data->proses_tl_nominal, 0)}}</td>
                        ...
                        <td class="border-b dark:border-dark-5">{{$data->setor_uang_ke_negara == null ? '-' : number_format($data->setor_uang_ke_negara, 0)}}</td>
                        <td class="border-b dark:border-dark-5">
                            <div class="box mt-5">
                            {{-- <a class="btn btn-sm btn-warning mr-1 mb-2" href="javascript:;">
                                <i data-feather="edit" class="w-3 h-3"></i>
                            </a> --}}
                            <a class="btn btn-sm  btn-danger mr-1 mb-2" href="{{ url('temuan-eksternal/'.$data->id.'/delete') }}">
                ...
                <tfoot>
                    <tr class="bg-gray-700 dark:bg-dark-1 text-white" style="width=100%">
                        ...
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">{{number_format($rekomendasi_jumlah_total)}}</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">{{number_format($rekomendasi_nominal_total)}}</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">{{number_format($selesai_jumlah_total)}}</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">{{number_format($selesai_nominal_total)}}</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">{{number_format($proses_tl_jumlah_total)}}</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">{{number_format($proses_tl_nominal_total)}}</th>
                        ...
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">{{number_format($setor_uang_ke_negara_total)}}</th>
