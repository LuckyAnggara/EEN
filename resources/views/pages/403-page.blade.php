...
@section('head')
    <title>Error Page - 403 Unauthorized</title>
@endsection
    ...
    <div class="container">
        ...
        <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
            ...
            <div class="text-white mt-10 lg:mt-0">
                ...
                <div class="intro-x text-xl lg:text-3xl font-medium mt-5">Oops. Halaman ini tidak bisa di Akses.</div>
                <div class="intro-x text-lg mt-3">Silahkan cek jenis User Anda.</div>
